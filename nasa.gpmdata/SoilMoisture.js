...
let nd = getFromDay(2019,12,1,false,false,2020,3,1);// 迭代获取时间，从 20150101 开始到今天为止
let d;          // 获取一个时间
let out = [];   // 输出内容
...
let getCommandLine = (d) => {
    ...
    // let find = ['0300','0900','1500','2100'];
    // let find = ['0000','0600','1200','1800'];
...
fs.writeFileSync('GLDAS_NOAH025_3H_20191131_2020_2_29.bat',out.join('\r\n'),'utf-8');
